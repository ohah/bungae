      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { label: '개요', slug: 'guides/architecture', translations: { en: 'Overview' } },
            {
              ...
              translations: { en: 'Bundling Pipeline' },
            },
            {
              label: '플러그인 시스템',
              slug: 'guides/plugins',
        ...
        },
        {
          ...
          items: [
            ...
            {
              label: 'HMR & Fast Refresh',
              slug: 'guides/hmr',
              translations: { en: 'HMR & Fast Refresh' },
            },
            {
              label: '프로덕션 빌드',
              slug: 'guides/production',
              translations: { en: 'Production Build' },
            },
          ],
        },
        {
        ...
        },
        {
          ...
          items: [
            { label: 'CLI', slug: 'reference/cli', translations: { en: 'CLI' } },
            {
              ...
              translations: { en: 'Config Options' },
            },
          ],
        },
      ],
